            ...
            <div class="nav-container">
                ...
                <nav class="main-nav">
                    <ul>
                        ...
                        <li><a href="create_poll.php" class="nav-link active">Create Poll</a></li>
        ...
        <main>
            <div class="create-poll-container container-narrow"> <!-- Specific container class -->
                 <div class="create-poll-header">
                    ...
                    <a href="dashboard.php" class="btn btn-secondary">Back to Dashboard</a> <!-- Secondary style button -->
                </div>
